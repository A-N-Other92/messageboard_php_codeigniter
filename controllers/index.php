...
class Messageboard extends CI_Controller {
        ...
        public function register()
        {
            ...
            else
            {
               ...
               $bdy = '<h3>To register for the message board click the link below</h3>
                      <h2><a href=http://www.examples.net84.net/codeigniter3/index.php/messageboard/activate_account/' . rawurlencode($un) . '/' . rawurlencode($pw) . '>Click here to register on the messageboard</a></h2><BR>
        ...
        public function newmessages($topicid)
        {
            ...
            $this->form_validation->set_rules('messagebox', 'message', 'trim|required|strip_tags');
